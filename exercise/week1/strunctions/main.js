...
//     return word.concat(firstLetter)
// }

// console.log(moveLetter("Eazy"))

// function connect (word1, word2){
//     return word1.toLowerCase() + ' ' + word2.toUpperCase()
//     ;
//     for(var i = 0; i < twoWords.length; i++){
//         twoWords[i] = twoWords[i].split(',');
//     }
// }
